    ...
    <div class="bg-white rounded-lg shadow-lg">
        <div class="p-6 border-b border-gray-200 flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Total:
                    {{ count($grade_students) }}</span>
                <a href="{{ route('add.data.grade') }}"
                    class="px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 font-medium flex items-center gap-2">
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50 transition-all duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-2">
                                        <a href="{{ route('grade.edit', $grade_student->id) }}" class="text-blue-600 hover:text-blue-900">
