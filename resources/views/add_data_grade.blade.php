<x-admin-layout>
    ...
    <div class="bg-white rounded-lg shadow-lg">
        <div class="p-6 border-b border-gray-200 flex items-center gap-3">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Add New Grade</h2>
        </div>

        <div class="p-6">
            <form action="{{ route('grade.store') }}" method="POST" class="max-w-3xl mx-auto space-y-6">
                @csrf
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select id="departmen_id"
                            ...
                            @foreach($departmens as $department)
                                <option value="{{ $department->id }}" {{ old('departmen_id') == $department->id ? 'selected' : '' }}>
                                    {{ $department->name }}
                                </option>
                            @endforeach
                        </select>
