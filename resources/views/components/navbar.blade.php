        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="https://i1.sndcdn.com/artworks-fMvH4X2jWV6Vrz5X-uqWFow-t1080x1080.jpg"
                        alt="Your Company">
                </div>
                        ...
                        <div>
                            <button type="button" @click="isOpen = !isOpen"
                                ...
                                <img class="h-8 w-8 rounded-full"
                                    src="https://pm1.aminoapps.com/6676/dd45f87ac59b3e30d17b77a22d9547b658486ee0_00.jpg"
                                    alt="">
                            </button>
                        </div>
            ...
            <div class="flex items-center px-5">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full"
                        src="https://i1.sndcdn.com/artworks-fMvH4X2jWV6Vrz5X-uqWFow-t1080x1080.jpg" alt="">
                </div>
                <div class="ml-3">
